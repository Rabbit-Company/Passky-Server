...
class Errors{
	...
	public static $errors = array (
		...
		"300" => "Website needs to be encrypted with AES-256.",
		"301" => "Username needs to be encrypted with AES-256.",
		"302" => "Password needs to be encrypted with AES-256.",
		"303" => "Message needs to be encrypted with AES-256.",
